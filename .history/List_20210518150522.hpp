...
/*   Updated: 2021/05/18 15:05:22 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    private:
        ...
        void insert_begin(const_reference val)
        {
            ...
            std::cout << "position.get_node()->val" << position.get_node()->prev << std::endl;
           

            //Pointer points to last Node
            Node *last = this->_node->prev;
            std::cout << "last->val" << last->val << std::endl;
            std::cout << "this->_node->val" << this->_node->next->val << std::endl;

            Node *new_node = construct_node(val); // Inserting data

            // setting up previous and next of new node
            new_node->next = this->_node->next;
            new_node->prev = last;
