...
/*   Updated: 2021/06/03 17:58:26 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    public:
        ...
        template <class Iter>
        MapIterator(MapIterator<Iter, TreeNode, Compare> const &my_it) : _node(my_it.get_node()), _comp(Compare) {} // Copy constructor

        MapIterator &operator=(MapIterator<T, TreeNode, Compare> const &rhs) // asignment operator
        {
