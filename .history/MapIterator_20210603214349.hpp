...
/*   Updated: 2021/06/03 21:43:49 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    class MapReverseIterator : public myReverseIterator
    {
        public:
        typedef Compare key_compare;
        ...
        template <class Iter>
        MapReverseIterator(MapReverseIterator<Iter, TreeNode, key_compare> const &my_it) : _node(my_it.get_node()) {} // Copy constructor

        MapReverseIterator &operator=(MapReverseIterator<Iter, TreeNode, key_compare> const &rhs) // asignment operator
        {
            this->_node = rhs.get_node();
            this->_comp = rhs._comp;
            return (*this);
