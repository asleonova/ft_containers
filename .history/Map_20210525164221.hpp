...
/*   Updated: 2021/05/25 16:42:21 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
   ...
   NULL left and right pointers. */
        TreeNode *newNode(int key)
        {
           ...
           _last_node->parent = this->_node;
           _node->right = this->_last_node;
            _node->left = NULL;
            _node->height = 1; // new node is initially
                              // added at leaf
            return (node);
        }
        ...
        TreeNode *insert(const value_type &key)
        {
