...
/*   Updated: 2021/05/25 17:37:23 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
   ...
   NULL left and right pointers. */
        ...
        TreeNode *insert_node(TreeNode *node, const value_type &val)
        {
            ...
            if (val.first < node->val)
                node->left = insert(node->left, val);
            else if (val.first > node->val)
        ...
        unbalanced */
            ...
            // Left Left Case
            if (balance > 1 && val < node->left->val.first)
                return rightRotate(node);

            // Right Right Case
            if (balance < -1 && val > node->right->val.first)
