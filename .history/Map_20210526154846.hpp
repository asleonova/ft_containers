...
/*   Updated: 2021/05/26 15:48:46 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
   ...
   NULL left and right pointers. */
        ...
        TreeNode *insert_node(TreeNode *node, const value_type &val)
        {
            ...
            /* 3. Update height of this ancestor node */
            node->height = 1 + max(height(node->left),
                                   height(node->right));

            /* 4. Update the right of this ancestor node */

            

            /* 5. Get the balance factor of this ancestor
