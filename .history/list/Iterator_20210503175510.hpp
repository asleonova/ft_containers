...
/*   Updated: 2021/05/03 17:55:10 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    public:
        ...
        explicit myIterator(const T &it, Node* node = 0) : _node(it) {} // initialization constructor

        template <class Iter>
        myIterator(const myIterator<Iter> &my_it, Node* node = 0) : _node(my_it.base()) {} // copy constructor
