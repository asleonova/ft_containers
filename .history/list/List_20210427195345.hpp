...
/*   Updated: 2021/04/27 19:53:45 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    private:
        ...
        Node *construct_node(const_reference val)
        {
            ...
            this->_alloc_node.construct(&tmp->val, val);
            return (node);
        }

        Node *create_node(const_reference val) // creates the very first node
        {
            this->_node = allocate_node();
            this->_alloc_node.construct(&this->_node->val, val);
            this->_node->next = this->_node;
            this->_node->prev = this->_node;
            return (this->_node);
        }

        Node *create_node() // creates the very first node
        {
            this->_node = allocate_node();
            this->_node->next = this->_node;
            this->_node->prev = this->_node;
