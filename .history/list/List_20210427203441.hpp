...
/*   Updated: 2021/04/27 20:34:41 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
    ...
    public:
      ...
      //  typedef typename ft::myIterator<value_type> iterator;
       ...
       // typedef typename ft::myReverseIterator<iterator> reverse_iterator;
        ...
        typedef Alloc::template rebind<Node>::other node_allocator_type; // мб это не нужно, так как указала в приватных по=другому
