...
/*   Updated: 2021/05/03 18:40:53 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    public:
        ...
        // iterator end()
        // {
        //     return iterator(this->_node->prev);
        // }

        // const_iterator end() const
        // {
        //     return const_iterator(this->_node->prev);
        // }
        ...
        reference front() { return *(this->_node->next->val); }

        const_reference front() const { return *(this->_node->next->val); }

        reference back() { return *(this->_node->val); }

        const_reference back() const { return *(this->_node->val); }
