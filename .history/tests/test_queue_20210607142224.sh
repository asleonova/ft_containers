...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/06/07 14:22:13 by dbliss            #+#    #+#              #
#    Updated: 2021/06/07 14:22:13 by dbliss           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
clang++ -Wall -Wextra -Werror ft_queue_test.cpp -o logs/ft_queue && 
./logs/ft_queue > logs/user.output
...
clang++ -Wall -Wextra -Werror std_queue_test.cpp -o logs/std_queue &&
./logs/std_queue > logs/std.output
