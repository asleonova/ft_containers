...
/*   Updated: 2021/03/30 13:40:13 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    class iterator
    {
        public:
            ...
            iterator operator-(int n) const; // between an iterator and int value
            iterator operator+(int n) const; // between iterator and iterator
            terator operator-(int n) const; // between iterator and iterator
