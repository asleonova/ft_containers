...
/*   Updated: 2021/04/12 12:54:11 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    template <class Iterator>
    bool operator==(const myReverse_iterator<Iterator>& lhs, const meReverse_iterator<Iterator>& rhs)
    {

    }

    template <class Iterator>
    bool operator!=(const myReverse_iterator<Iterator>& lhs, const myReverse_iterator<Iterator>& rhs)
    {
