...
/*   Updated: 2021/04/12 13:55:37 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    public:
        ...
        explicit myIterator(iterator_type type) : _type(type) {} // initialization constructor
        
        template <typename Y>
        myIterator(const myReverse_iterator<Iter> &rev_type) : _type(rev_type._type) {}
    ...
    private:
        ...
        explicit myIterator(const T &ptr) : _ptr(ptr) {}
