...
/*   Updated: 2021/04/23 18:16:54 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    template <class Iterator>
    class myConstReverse_iterator : public ft::myIterator
    {
        private:
            T *_ptr;
        public:
            myConstIterator() : _ptr(NULL) {} // default

            explicit myConstIterator(const T &ptr) : _ptr(ptr) {} // initialization constructor

            template <typename Y>
            myConstIterator(const myIterator<Y> &rhs) : _ptr(rhs._ptr) {} // copy constructor
