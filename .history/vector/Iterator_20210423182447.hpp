...
/*   Updated: 2021/04/23 18:24:47 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template<typename T>
		inline bool
		operator==(const myIterator<T> &lhs, const myIterator<T> &rhs)
		{
			return (lhs.base() == rhs.base());
		}
	...
	template<typename T, typename U>
		inline bool
		operator==(const myIterator<T> &lhs, const myIterator<U> &rhs)
		{
			return (lhs.base() == rhs.base());
		}
	...
	template<typename T>
		inline myIterator<T>
		operator+(typename myIterator<T>::difference_type n, const myIterator<T> &it)
		{
			return (myIterator<T>(it.base() + n));
		}

	template<typename T, typename U>
		inline typename myIterator<T>::difference_type
		operator-(const myIterator<T> &lhs, const myIterator<U> &rhs)
		{
			return (lhs.base() - rhs.base());
		}
