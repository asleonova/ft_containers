...
/*   Updated: 2021/04/23 19:10:28 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    template <class T>
    class MyConstIterator : public myIterator<T>
    {
    public:
        typedef T value_type;
        typedef T &reference;
        ...
        typedef ptrdiff_t difference_type;
        MyConstIterator() {}
        MyConstIterator(pointer _ptr) : myIterator<T>(_ptr) {}
        MyConstIterator(MyConstIterator const &copy) { *this = copy; }
        myConstIterator &operator=(myConstIterator const &copy)
        {
            this->_ptr = copy._ptr;
            return (*this);
        }
