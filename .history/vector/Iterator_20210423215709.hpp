...
/*   Updated: 2021/04/23 21:57:09 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    public:
        ...
        explicit myIterator(iterator_type it) : _ptr(ptr) {} // initialization constructor

        template <class T>
        myIterator(const myIterator<T> &my_it) : _ptr(my_it.base()) {} // copy constructor
