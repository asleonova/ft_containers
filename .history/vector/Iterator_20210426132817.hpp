...
/*   Updated: 2021/04/26 13:28:17 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    template <class T>
    class myIterator : public ft::iterator<ft::myIterator_tag, T> // нужно конечно же будет изменить для каждого типа!!! когда сд
    {
    private:
        T _ptr;
