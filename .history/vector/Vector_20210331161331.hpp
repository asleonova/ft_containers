...
/*   Updated: 2021/03/31 16:13:31 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class vector
	{
		...
		/* 4 CONSTRUCTORS: */
			explicit vector(const allocator_type& alloc = allocator_type()) { _v_begin(NULL) } // #1: default constructor
		...
		/* ITERATORS */
		iterator begin() { return return (iterator(&(front()))); }
		// iterator end();
