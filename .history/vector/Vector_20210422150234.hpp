...
/*   Updated: 2021/04/22 15:02:34 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	public:
		...
		//#4: copy constructor: */
		explicit vector(vector const &src) : _v_begin(NULL), _v_end(NULL), _capacity(NULL)
		{
			this->allocator_type = src.allocator_type;
			insert(this->begin(), src.begin(), src.end()); 
		}
