...
/*   Updated: 2021/04/22 14:04:01 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_int_array_std(std::vector<int> &vec)
{
...
void constructor_test()
{
	...
	std::vector<int>::iterator ite = vec5.begin();
	std::vector<int> vec5(ite, ite + 2);
	print_int_array_std(vec5);
	std::cout << std::endl;
