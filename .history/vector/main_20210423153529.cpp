...
/*   Updated: 2021/04/23 15:35:29 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void modifiers_test()
{
	...
	it = first.begin() + 1;
	std::cout << green << "assign 5 central values of first (assign range)" << cend << "\n";
	second.assign(it, first.end() - 1); // the 5 central values of first
	std::cout << "vector contents: " << std::endl;
	print_int_array(second);

	std::cout << green << "creating array of ints {1776, 7, 4} and assigning from it (assign fill): " << cend << "\n";	
	int myints[] = {1776, 7, 4};
