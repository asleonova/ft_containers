...
/*   Updated: 2021/04/23 22:26:10 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_float_array(std::vector<float> &vec)
{
	std::vector<float>::iterator it = vec.begin();
	std::vector<float>::iterator ite = vec.end();
	while (it != ite)
	{
		std::cout << *it << " | ";
		it++;
...
void print_double_array(std::vector<double> &vec)
{
	std::vector<double>::iterator it = vec.begin();
	std::vector<double>::iterator ite = vec.end();
	while (it != ite)
	{
		std::cout << *it << " | ";
		it++;
...
void print_string_array(std::vector<std::string> &vec)
{
...
void element_access_test()
{
	...
	std::vector<std::string> myvector(10); // 10 zero-initialized elements
...
void modifiers_test()
{
	...
	std::cout << green << "vector contents astder clear() : " << cend << "\n";
	vs1.clear();
	print_string_array(vs1);
	std::cout << "vector size: " << vs1.size();
	std::cout << " | vector capacity: " << vs1.capacity() << std::endl;
	...
	void non_member_functions()
{
	...
	std::vector<int>		v0(6, 42);
	std::vector<int>		v1(9, 21);
